    ...
    const email: email = {
        ...
        text: customers.map(
          ...
          Dear ${capitalize(customer.fname)},
            ...
            ${capitalize("Experience")} luxury like never before! For a limited time, we're thrilled to offer you an exclusive **${offer.percentage} discount**
            on our ${roomType.name} Rooms at Hotel Plaza. <br>
