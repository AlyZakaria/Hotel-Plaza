...
paypal.configure({
    'mode': 'sandbox',
    'client_id': 'AQumhrYOGkkqehiNsK-5sPeoyIVt_3Cj69zWzl9cUm7cUvkfxsbfXxg0iX0nGLn7gu85EUtfhJXI1xpt',
    'client_secret': 'EEqIFUBqpaXg4xJfzrb36jD2wxPdDzrGTwFoJZlGghbJ2S8bPiw5tzQtycFXYR2iG0hCeNNkl1_7vCfU'
});
    ...
    async createBooking(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            for (var i = 0; i < rooms.length; i++) {
                totalprice += parseInt(rooms[i].quantity) * parseFloat(rooms[i].price)
            }
